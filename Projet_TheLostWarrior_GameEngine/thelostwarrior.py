...
walkRight = [pygame.image.load('bald.png'), pygame.image.load('bald.png'), pygame.image.load('bald.png'),
             pygame.image.load('bald.png'), pygame.image.load('bald.png'), pygame.image.load('bald.png'),
             pygame.image.load('bald.png'), pygame.image.load('bald.png'), pygame.image.load('bald.png')]

# liste contenant des images du personnage se déplaçant vers la gauche
walkLeft = [pygame.image.load('bald.png'), pygame.image.load('bald.png'), pygame.image.load('bald.png'),
            pygame.image.load('bald.png'), pygame.image.load('bald.png'), pygame.image.load('bald.png'),
            pygame.image.load('bald.png'), pygame.image.load('bald.png'), pygame.image.load('bald.png')]

# image de fonds
bg = pygame.image.load('darkforest.png')

# image du persoannge mobile
char = pygame.image.load('bald.png')
